...
function createData(gatewayid, gatewayname, gatewayaddress, protocol, deviceprofile, location, timestamp,  method, action) {
  return {
    gatewayid, gatewayname, gatewayaddress, protocol, deviceprofile, location, timestamp,  method, action
  };
}

const rows = [
  createData('Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples'),
  createData('Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples'),
  createData('Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples'),
  createData('Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples'),
  createData('Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples', 'Samples'),
              ...
              .map((row, index) => {
                ...
                return (
                  <TableRow hover onClick={(event) => handleRowClick(event, row.gatewayid)} role="checkbox" aria-checked={isItemSelected} tabIndex={-1} key={row.gatewayid} selected={isItemSelected}>
                    ...
                    <TableCell component='td' size='small'>{row.gatewayaddress}</TableCell>
                    <TableCell component='td' size='small'>{row.protocol}</TableCell>
                    <TableCell component='td' size='small'>{row.deviceprofile}</TableCell>
                    <TableCell component='td' size='small'>{row.location}</TableCell>
                    <TableCell component='td' size='small'>{row.timestamp}</TableCell>
                    <TableCell component='td' size='small'>{row.method}</TableCell>
