...
class MultiSelectDatameasured extends React.Component {
  state = {
  ...
  render() {
    return (
      <div
        className={`multiselect-wrapper ${this.state.dropdownActive ? "is-active" : ""
          }`}
      ...
      >
        ...
        >
          <span
            className={`multiselect__placeholder ${this.state.selectedOptions.length ? "is-hidden" : ""
              }`}
          >
            Device Data
          </span>
          <span
            className={`multiselect__arrow-icon fa ${this.state.dropdownActive ? "fa-chevron-up" : "fa-chevron-down"
              }`}
          />
        ...
        <div
          className={`multiselect__result-area ${this.state.dropdownActive ? "is-active" : ""
            }`}
        >
          ...
          <ul className="multiselect-results">
            {this.state.filteredOptions.map((option, index) => (
              <li
                key={option.value}
                className={`multiselect-results__item ${this.isChecked(option.value) ? "is-active" : ""
...
export default MultiSelectDatameasured;
